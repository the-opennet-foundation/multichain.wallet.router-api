import fs from 'fs';
import type { ResponseLike } from 'multichain.wallet.router-api/internal/to-file';
import { toFile } from 'multichain.wallet.router-api/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('multichain.wallet.router-api/core/uploads');
    await expect(
